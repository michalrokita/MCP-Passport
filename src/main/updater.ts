...
//   { autoCheck: boolean, skippedVersion: string | null, lastCheckedAt: string | null }

import { app, BrowserWindow, net } from 'electron'
import { join } from 'path'
import { readJsonSafe, writeJsonAtomic } from './util'
import type { UpdateInfo, UpdatePrefs, UpdateCheckResult, UpdateStatusEvent } from '../shared/types'

const RELEASES_URL = 'https://api.github.com/repos/michalrokita/MCP-Passport/releases/latest'
